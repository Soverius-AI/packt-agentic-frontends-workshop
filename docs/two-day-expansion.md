...
- Build the basic SDK chat, replace it with CopilotKit plus AG-UI, move the agent from BuiltInAgent to Mastra, and only then add the generated-SQL tool rather than starting from the completed coordinator.
