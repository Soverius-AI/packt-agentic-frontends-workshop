...
The `packt-webinar-02` worktree now uses branch `webinar-06`; select state 02
...
`webinar-03` through `webinar-06` are prepared. Branches `webinar-07` through `webinar-08` will be created
