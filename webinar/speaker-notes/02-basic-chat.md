...
The `packt-webinar-02` worktree now uses branch `webinar-05`; select state 02
...
`webinar-03` through `webinar-05` are prepared. Branches `webinar-06` through `webinar-08` will be created
