...
**Current worktree:** `packt-webinar-02` now has branch `webinar-06` checked out; select 03 to rehearse this chapter.
...
The selector restores all twelve checkpoint paths, including the empty Mastra starting state, including file creation and
