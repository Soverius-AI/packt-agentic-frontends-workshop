...
| 02        | Conversation alone gives no access to facility data.                    | Activate BasicChatComponent; write the OpenAI call; enable chat.              | `/api/chat`; ordinary answer versus unavailable facility knowledge.         | [02](speaker-notes/02-basic-chat.md)       |
